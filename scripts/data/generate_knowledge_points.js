...
function main() {
  ...
  const templates = [
    ...
    // ===== 继续扩充：中国史主线 + 常见专题（更多覆盖中小学学习过程）=====
    {
      title: '儒家与国家治理：从思想传统到政治文化（概念）',
      stage: '初中',
      category: '中国古代史/思想文化',
      period: '先秦-两汉',
      summary: '理解儒家思想如何影响政治理念、社会伦理与教育传统，并认识其在不同历史阶段的变化。',
      keyPoints: [
        '儒家核心议题：仁、礼、修身与社会秩序',
        '思想传统如何进入制度：教育、选官与政治文化',
      ],
      references: [
        { title: '维基百科：儒家', url: 'https://zh.wikipedia.org/wiki/%E5%84%92%E5%AE%B6' },
        { title: '维基百科：儒学', url: 'https://zh.wikipedia.org/wiki/%E5%84%92%E5%AD%A6' },
      ],
    },
    {
      title: '丝绸之路与中外交流：陆上与海上两条网络（概念）',
      stage: '初中',
      category: '中国古代史/对外关系',
      period: '汉-唐-宋元',
      summary: '用“网络”的视角理解贸易、宗教、技术与文化如何跨区域流动，并认识交流对社会的影响。',
      keyPoints: [
        '陆上与海上交流：路线、商品与人群',
        '交流的多重影响：经济、宗教与文化传播',
      ],
      references: [
        { title: '维基百科：丝绸之路', url: 'https://zh.wikipedia.org/wiki/%E4%B8%9D%E7%BB%B8%E4%B9%8B%E8%B7%AF' },
        { title: '维基百科：海上丝绸之路', url: 'https://zh.wikipedia.org/wiki/%E6%B5%B7%E4%B8%8A%E4%B8%9D%E7%BB%B8%E4%B9%8B%E8%B7%AF' },
      ],
    },
    {
      title: '三国鼎立与政治格局：从赤壁到统一的历史逻辑（概念）',
      stage: '初中',
      category: '中国古代史/政治',
      period: '东汉末-三国',
      summary: '理解东汉末的社会动荡、军阀割据与三国鼎立格局，认识“统一—分裂”循环中的结构性因素。',
      keyPoints: [
        '分裂的成因：财政、军事与地方势力',
        '格局塑造：联盟、战争与政治整合',
      ],
      relatedEventTitles: ['赤壁之战', '官渡之战'],
      references: [
        { title: '维基百科：三国', url: 'https://zh.wikipedia.org/wiki/%E4%B8%89%E5%9B%BD' },
        { title: '维基百科：东汉末年', url: 'https://zh.wikipedia.org/wiki/%E4%B8%9C%E6%B1%89%E6%9C%AB%E5%B9%B4' },
      ],
    },
    {
      title: '佛教东传与文化融合：宗教、艺术与思想互动（概念）',
      stage: '初中',
      category: '中国古代史/思想文化',
      period: '两汉-魏晋南北朝-隋唐',
      summary: '理解佛教传入中国后的传播与本土化过程，并认识宗教与艺术、哲学的相互影响。',
      keyPoints: [
        '传播路径：交流网络与译经活动',
        '本土化与融合：思想互动与文化表达',
      ],
      references: [
        { title: '维基百科：佛教传入中国', url: 'https://zh.wikipedia.org/wiki/%E4%BD%9B%E6%95%99%E4%BC%A0%E5%85%A5%E4%B8%AD%E5%9B%BD' },
        { title: '维基百科：石窟艺术', url: 'https://zh.wikipedia.org/wiki/%E7%9F%B3%E7%AA%9F%E8%89%BA%E6%9C%AF' },
      ],
    },
    {
      title: '隋的统一与制度恢复：从分裂到再整合（概念）',
      stage: '初中',
      category: '中国古代史/政治',
      period: '隋',
      summary: '理解隋朝在长期分裂后实现统一、恢复制度与交通建设的意义，并认识其短暂性背后的压力。',
      keyPoints: [
        '统一与整合：制度、交通与财政',
        '动员成本：大型工程与社会负担',
      ],
      references: [
        { title: '维基百科：隋朝', url: 'https://zh.wikipedia.org/wiki/%E9%9A%8B%E6%9C%9D' },
        { title: '维基百科：隋炀帝', url: 'https://zh.wikipedia.org/wiki/%E9%9A%8B%E7%82%80%E5%B8%9D' },
      ],
    },
    {
      title: '唐代对外交流与开放气象：长安与海陆通道（概念）',
      stage: '初中',
      category: '中国古代史/对外关系',
      period: '唐',
      summary: '理解唐代在贸易、外交与文化交流方面的活跃特征，认识开放城市与交流网络的作用。',
      keyPoints: [
        '国际化都市：人口流动与文化多样性',
        '交流网络：商贸、外交与宗教传播',
      ],
      references: [
        { title: '维基百科：唐朝', url: 'https://zh.wikipedia.org/wiki/%E5%94%90%E6%9C%9D' },
        { title: '维基百科：长安', url: 'https://zh.wikipedia.org/wiki/%E9%95%BF%E5%AE%89' },
      ],
    },
    {
      title: '赋税制度的演变：均田制到两税法（概念）',
      stage: '高中',
      category: '中国古代史/经济与制度',
      period: '北魏-隋唐',
      summary: '理解土地与赋税制度如何与人口、财政、军政体系相互作用，并认识制度调整的背景。',
      keyPoints: [
        '均田制：土地分配与户籍控制的尝试',
        '两税法：财政结构变化与税制调整',
      ],
      references: [
        { title: '维基百科：均田制', url: 'https://zh.wikipedia.org/wiki/%E5%9D%87%E7%94%B0%E5%88%B6' },
        { title: '维基百科：两税法', url: 'https://zh.wikipedia.org/wiki/%E4%B8%A4%E7%A8%8E%E6%B3%95' },
      ],
    },
    {
      title: '军事制度与国家动员：府兵制到募兵制（概念）',
      stage: '高中',
      category: '中国古代史/军事与制度',
      period: '隋唐-宋',
      summary: '理解军制变化背后的财政、社会结构与战争形态变化，并认识国家动员方式的转型。',
      keyPoints: [
        '府兵制：兵农合一与地方社会',
        '募兵制：职业军队与财政压力',
      ],
      references: [
        { title: '维基百科：府兵制', url: 'https://zh.wikipedia.org/wiki/%E5%BA%9C%E5%85%B5%E5%88%B6' },
        { title: '维基百科：募兵制', url: 'https://zh.wikipedia.org/wiki/%E5%8B%9F%E5%85%B5%E5%88%B6' },
      ],
    },
    {
      title: '经济重心南移：人口迁徙、农业与城市发展（概念）',
      stage: '初中',
      category: '中国古代史/经济',
      period: '唐宋之际-宋',
      summary: '理解南方开发、人口流动与经济结构变化，认识“区域发展”对历史格局的影响。',
      keyPoints: [
        '人口与资源：迁徙与土地开发',
        '商业与城市：市场扩张与生活方式变化',
      ],
      references: [
        { title: '维基百科：经济重心南移', url: 'https://zh.wikipedia.org/wiki/%E7%BB%8F%E6%B5%8E%E9%87%8D%E5%BF%83%E5%8D%97%E7%A7%BB' },
        { title: '维基百科：两宋', url: 'https://zh.wikipedia.org/wiki/%E5%AE%8B%E6%9C%9D' },
      ],
    },
    {
      title: '理学与士大夫文化：宋明思想传统（概念）',
      stage: '高中',
      category: '中国古代史/思想文化',
      period: '宋-明',
      summary: '理解理学作为思想体系如何影响教育、政治伦理与社会文化，并认识其历史语境。',
      keyPoints: [
        '理学的核心关切：道德修养与秩序',
        '士大夫文化：教育、科举与公共话语',
      ],
      references: [
        { title: '维基百科：理学', url: 'https://zh.wikipedia.org/wiki/%E7%90%86%E5%AD%A6' },
        { title: '维基百科：朱熹', url: 'https://zh.wikipedia.org/wiki/%E6%9C%B1%E7%86%B9' },
      ],
    },
    {
      title: '明代海禁与朝贡贸易：对外政策的多面性（概念）',
      stage: '高中',
      category: '中国古代史/对外关系',
      period: '明',
      summary: '理解明代对外贸易管理与海禁政策的背景与影响，并区分官方秩序与民间交流的差别。',
      keyPoints: [
        '海禁政策：秩序、治安与财政考量',
        '朝贡与贸易：官方体系与实际经济活动',
      ],
      references: [
        { title: '维基百科：海禁', url: 'https://zh.wikipedia.org/wiki/%E6%B5%B7%E7%A6%81' },
        { title: '维基百科：朝贡体系', url: 'https://zh.wikipedia.org/wiki/%E6%9C%9D%E8%B4%A1%E4%BD%93%E7%B3%BB' },
      ],
    },
    {
      title: '清代多民族国家：疆域、治理与民族关系（概念）',
      stage: '初中',
      category: '中国古代史/民族与疆域',
      period: '清',
      summary: '理解清代作为多民族国家在疆域治理、制度安排与民族关系方面的特征。',
      keyPoints: [
        '疆域治理：制度与地方治理形式',
        '民族关系：交往、管理与融合的多样方式',
      ],
      references: [
        { title: '维基百科：清朝', url: 'https://zh.wikipedia.org/wiki/%E6%B8%85%E6%9C%9D' },
        { title: '维基百科：多民族国家', url: 'https://zh.wikipedia.org/wiki/%E5%A4%9A%E6%B0%91%E6%97%8F%E5%9B%BD%E5%AE%B6' },
      ],
    },
    {
      title: '近代列强侵略与民族危机：条约体系与主权问题（概念）',
      stage: '初中',
      category: '中国近代史/国际关系',
      period: '1840-1900',
      summary: '理解近代条约体系与主权问题在中国近代史叙事中的位置，认识外部冲击与内部转型的叠加。',
      keyPoints: [
        '条约体系：通商口岸、领事裁判权等概念入门',
        '危机与转型：制度与社会结构的压力',
      ],
      references: [
        { title: '维基百科：不平等条约', url: 'https://zh.wikipedia.org/wiki/%E4%B8%8D%E5%B9%B3%E7%AD%89%E6%9D%A1%E7%BA%A6' },
        { title: '维基百科：晚清', url: 'https://zh.wikipedia.org/wiki/%E6%B8%85%E6%9C%AB' },
      ],
    },
    {
      title: '甲午之后的改革与民族意识：从维新到立宪思潮（概念）',
      stage: '高中',
      category: '中国近代史/思想与政治',
      period: '1895-1911',
      summary: '理解甲午战争后的改革思潮与政治方案，并认识民族意识与现代国家观念的变化。',
      keyPoints: [
        '改革方案的差异：制度设计与社会基础',
        '民族意识与国家观念：公共舆论与政治动员',
      ],
      relatedEventTitles: ['甲午中日战争', '戊戌变法'],
      references: [
        { title: '维基百科：晚清改革', url: 'https://zh.wikipedia.org/wiki/%E6%B8%85%E6%9C%AB%E6%96%B0%E6%94%BF' },
        { title: '维基百科：立宪运动', url: 'https://zh.wikipedia.org/wiki/%E7%AB%8B%E5%AE%AA%E8%BF%90%E5%8A%A8' },
      ],
    },
    {
      title: '辛亥革命后的政治与社会：共和制度的挑战（概念）',
      stage: '高中',
      category: '中国近现代史/政治',
      period: '1911-1920s',
      summary: '理解从帝制到共和的制度转换带来的政治整合挑战与社会转型压力。',
      keyPoints: [
        '制度转换：法律、军队与财政体系重建',
        '政治整合：中央—地方关系与权力结构',
      ],
      relatedEventTitles: ['辛亥革命', '中华民国成立'],
      references: [
        { title: '维基百科：辛亥革命', url: 'https://zh.wikipedia.org/wiki/%E8%BE%9B%E4%BA%A5%E9%9D%A9%E5%91%BD' },
        { title: '维基百科：中华民国', url: 'https://zh.wikipedia.org/wiki/%E4%B8%AD%E5%8D%8E%E6%B0%91%E5%9B%BD' },
      ],
    },
    {
      title: '从局部冲突到全面抗战：时间线与关键节点（概念）',
      stage: '初中',
      category: '中国近现代史/战争与国家',
      period: '1931-1937',
      summary: '用时间线方式理解局部冲突到全面抗战的演变，训练“因果链”与“阶段特征”的把握。',
      keyPoints: [
        '阶段演变：冲突升级与战略选择',
        '社会动员：舆论、经济与组织形态变化',
      ],
      relatedEventTitles: ['全面抗战爆发'],
      references: [
        { title: '维基百科：九一八事变', url: 'https://zh.wikipedia.org/wiki/%E4%B9%9D%E4%B8%80%E5%85%AB%E4%BA%8B%E5%8F%98' },
        { title: '维基百科：七七事变', url: 'https://zh.wikipedia.org/wiki/%E4%B8%83%E4%B8%83%E4%BA%8B%E5%8F%98' },
      ],
    },
    {
      title: '抗战时期的社会与经济：动员、生产与生活（概念）',
      stage: '高中',
      category: '中国近现代史/社会与经济',
      period: '1937-1945',
      summary: '理解战争条件下的社会动员、经济调整与民众生活变化，认识战争对社会结构的深层影响。',
      keyPoints: [
        '动员与生产：资源配置与社会组织',
        '战时社会：人口流动与生活方式变化',
      ],
      ...
      references: [
        { title: '维基百科：抗日战争', url: 'https://zh.wikipedia.org/wiki/%E6%8A%97%E6%97%A5%E6%88%98%E4%BA%89' },
        { title: '维基百科：大后方', url: 'https://zh.wikipedia.org/wiki/%E5%A4%A7%E5%90%8E%E6%96%B9' },
      ],
    },
    {
      title: '冷战与地区冲突：朝鲜战争的国际背景（概念）',
      stage: '高中',
      category: '中国现代史/国际关系',
      period: '1950s',
      summary: '理解冷战格局下的安全困境与地区冲突，认识国际关系对国家决策的影响。',
      keyPoints: [
        '冷战格局：阵营对抗与安全困境',
        '地区冲突：局部战争与国际政治联动',
      ],
      relatedEventTitles: ['抗美援朝'],
      references: [
        { title: '维基百科：冷战', url: 'https://zh.wikipedia.org/wiki/%E5%86%B7%E6%88%98' },
        { title: '维基百科：朝鲜战争', url: 'https://zh.wikipedia.org/wiki/%E6%9C%9D%E9%B2%9C%E6%88%98%E4%BA%89' },
      ],
    },
    {
      title: '现代化与工业化：从近代起步到当代转型（概念）',
      stage: '高中',
      category: '中国近现代史/经济与社会',
      period: '19世纪-21世纪',
      summary: '用长时段视角理解中国现代化与工业化的阶段特征，识别不同阶段的动力与约束。',
      keyPoints: [
        '工业化要素：资本、技术、市场与制度',
        '阶段性特征：政策选择与外部环境变化',
      ],
      references: [
        { title: '维基百科：现代化', url: 'https://zh.wikipedia.org/wiki/%E7%8E%B0%E4%BB%A3%E5%8C%96' },
        { title: '维基百科：工业化', url: 'https://zh.wikipedia.org/wiki/%E5%B7%A5%E4%B8%9A%E5%8C%96' },
      ],
    },
  ]
