...
const dynastyGradients: Record<string, { start: string; end: string; name: string }> = {
  ...
  '西周': { start: '#D4AF37', end: '#F4D03F', name: '礼制金黄' }, // 金色，体现礼制正统
  '东周': { start: '#E67E22', end: '#F39C12', name: '东周橙黄' }, // 橙黄色，体现过渡期
  ...
  '西汉': { start: '#C0392B', end: '#E74C3C', name: '强盛朱红' }, // 朱红色，体现强盛繁荣
  '新朝': { start: '#7F8C8D', end: '#95A5A6', name: '短暂灰白' }, // 灰白色，体现短暂
  '东汉': { start: '#A93226', end: '#C0392B', name: '东汉深红' }, // 深红色，体现后期
  '三国': { start: '#6C3483', end: '#8E44AD', name: '英雄深紫' }, // 深紫色，体现英雄传奇
  '晋朝': { start: '#7D3C98', end: '#9B59B6', name: '短暂淡紫' }, // 淡紫色，体现短暂分裂
  '西晋': { start: '#7D3C98', end: '#9B59B6', name: '短暂淡紫' }, // 淡紫色，体现短暂统一
  '东晋': { start: '#6C3483', end: '#8E44AD', name: '东晋深紫' }, // 深紫色，体现偏安
  ...
  '初唐': { start: '#F39C12', end: '#F7DC6F', name: '初唐金黄' }, // 金黄色，体现初期强盛
  '盛唐': { start: '#F1C40F', end: '#F7DC6F', name: '盛唐辉煌' }, // 亮金色，体现鼎盛
  '中唐': { start: '#E67E22', end: '#F39C12', name: '中唐橙黄' }, // 橙黄色，体现转折
  '晚唐': { start: '#D35400', end: '#E67E22', name: '晚唐深橙' }, // 深橙色，体现衰落
  '宋朝': { start: '#1ABC9C', end: '#48C9B0', name: '文化青绿' }, // 青绿色，体现文化雅致
  '北宋': { start: '#1ABC9C', end: '#48C9B0', name: '文化青绿' }, // 青绿色，体现文化雅致
  '南宋': { start: '#16A085', end: '#1ABC9C', name: '南宋深绿' }, // 深绿色，体现偏安
  ...
  '清前期': { start: '#1B4F72', end: '#2874A6', name: '清前期深蓝' }, // 深蓝色，体现强盛
  '清中期': { start: '#34495E', end: '#5D6D7E', name: '清中期灰蓝' }, // 灰蓝色，体现转折
  '清后期': { start: '#2C3E50', end: '#34495E', name: '清后期暗蓝' }, // 暗蓝色，体现衰落
  '民国': { start: '#8E44AD', end: '#9B59B6', name: '民国紫色' }, // 紫色，体现现代转型
  '民国初期': { start: '#8E44AD', end: '#9B59B6', name: '民国初期紫' }, // 紫色，体现初期
  '民国中期': { start: '#7D3C98', end: '#8E44AD', name: '民国中期深紫' }, // 深紫色，体现中期
  '抗战时期': { start: '#C0392B', end: '#E74C3C', name: '抗战红色' }, // 红色，体现抗战
  '解放战争': { start: '#8B0000', end: '#C0392B', name: '解放深红' }, // 深红色，体现解放
  '中华人民共和国': { start: '#E74C3C', end: '#C0392B', name: '新中国红' }, // 红色，体现新中国
}
